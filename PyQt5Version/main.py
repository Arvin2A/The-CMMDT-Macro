...
from PyQt5.QtWidgets import QApplication, QWidget, QFileDialog, QMessageBox, QMainWindow, QTextEdit
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.sikulix_path = "PyQt5Version/sikulix.jar"
        self.load_data()
        #console
    ...
    def load_data(self):
        try:
            with open("PyQt5Version/macro.sikuli/data.json","r") as w:
                data = json.load(w)
